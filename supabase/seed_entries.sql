...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('NeoHorse-1-4B', 'TokenRhythm', 'Model', 'NLP', 'APACHE-2.0', 2026, '4B params', 'High-performance NLP open-weights model by TokenRhythm, trending with over 2,056 community likes and 11,904 downloads on Hugging Face.', 'TokenRhythm text generation architecture with community-tuned weights.', 'from transformers import AutoModelForCausalLM, AutoTokenizer

model = AutoModelForCausalLM.from_pretrained("TokenRhythm/NeoHorse-1-4B", device_map="auto")
tokenizer = AutoTokenizer.from_pretrained("TokenRhythm/NeoHorse-1-4B")', 'Trending Score: 392, Likes: 2,056, Downloads: 11,904', 'Requires GPU VRAM or quantization for efficient local deployment.', 'https://huggingface.co/TokenRhythm/NeoHorse-1-4B', '[{"text":"TokenRhythm/NeoHorse-1-4B on Hugging Face","url":"https://huggingface.co/TokenRhythm/NeoHorse-1-4B"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('ai-notes', 'Lynote', 'Platform', 'Multimodal', 'Community Hosted', 2026, 'STATIC Platform', 'Interactive AI web platform and demonstration hosted on Hugging Face Spaces by Lynote. Trending with 99 community stars.', 'STATIC cloud runtime container with interactive browser interface.', 'Launch and explore the platform directly in your browser: https://huggingface.co/spaces/Lynote/ai-notes', 'Trending Score: 81, Community Likes: 99', 'Cloud container subject to community traffic quotas and queue times.', 'https://huggingface.co/spaces/Lynote/ai-notes', '[{"text":"Lynote/ai-notes on Hugging Face Spaces","url":"https://huggingface.co/spaces/Lynote/ai-notes"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('Fable-5.1-Max-Reasoning-Filtered-5000x', 'MoreThought', 'Dataset', 'AI Coding', 'APACHE-2.0', 2026, '1K<n<10K', 'Dataset Description 	 This dataset contains 5,000 coding and reasoning traces generated by the new Fable 5.1 model using max reasoning effort. It holds almost 150,000,0 (50 likes, 950 downloads).', 'Parquet / Arrow structured tabular & tokenized dataset.', 'from datasets import load_dataset

dataset = load_dataset("MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x")', 'Trending Score: 33, Likes: 50, Downloads: 950', 'Subject to licensing compliance and dataset-specific terms of use.', 'https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x', '[{"text":"MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x on Hugging Face Datasets","url":"https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x"}]'::jsonb, false, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF', 'DavidAU', 'Model', 'Multimodal', 'APACHE-2.0', 2026, '27B params', 'High-performance Multimodal open-weights model by DavidAU, trending with over 798 community likes and 1,049,586 downloads on Hugging Face.', 'DavidAU image text to text architecture with community-tuned weights.', 'from transformers import AutoModelForCausalLM, AutoTokenizer
...
tokenizer = AutoTokenizer.from_pretrained("DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF")', 'Trending Score: 340, Likes: 798, Downloads: 1,049,586', 'Requires GPU VRAM or quantization for efficient local deployment.', 'https://huggingface.co/DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF', '[{"text":"DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF on Hugging Face","url":"https://huggingface.co/DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('hfviewer', 'embedl', 'Platform', 'Multimodal', 'Community Hosted', 2026, 'STATIC Platform', 'Interactive AI web platform and demonstration hosted on Hugging Face Spaces by embedl. Trending with 70 community stars.', 'STATIC cloud runtime container with interactive browser interface.', 'Launch and explore the platform directly in your browser: https://huggingface.co/spaces/embedl/hfviewer', 'Trending Score: 67, Community Likes: 70', 'Cloud container subject to community traffic quotas and queue times.', 'https://huggingface.co/spaces/embedl/hfviewer', '[{"text":"embedl/hfviewer on Hugging Face Spaces","url":"https://huggingface.co/spaces/embedl/hfviewer"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('ZDTaichu5.0-9B', 'TaichuAI', 'Model', 'Multimodal', 'Open Weights', 2026, '9B params', 'High-performance Multimodal open-weights model by TaichuAI, trending with over 1,041 community likes and 8,313 downloads on Hugging Face.', 'TaichuAI image text to text architecture with community-tuned weights.', 'from transformers import AutoModelForCausalLM, AutoTokenizer

model = AutoModelForCausalLM.from_pretrained("TaichuAI/ZDTaichu5.0-9B", device_map="auto")
tokenizer = AutoTokenizer.from_pretrained("TaichuAI/ZDTaichu5.0-9B")', 'Trending Score: 481, Likes: 1,041, Downloads: 8,313', 'Requires GPU VRAM or quantization for efficient local deployment.', 'https://huggingface.co/TaichuAI/ZDTaichu5.0-9B', '[{"text":"TaichuAI/ZDTaichu5.0-9B on Hugging Face","url":"https://huggingface.co/TaichuAI/ZDTaichu5.0-9B"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('Krea-2-Turbo_v2', 'Jackiesixnine', 'Platform', 'Multimodal', 'Community Hosted', 2026, 'GRADIO Platform', 'Interactive AI web platform and demonstration hosted on Hugging Face Spaces by Jackiesixnine. Trending with 113 community stars.', 'GRADIO cloud runtime container with interactive browser interface.', 'Launch and explore the platform directly in your browser: https://huggingface.co/spaces/Jackiesixnine/Krea-2-Turbo_v2', 'Trending Score: 86, Community Likes: 113', 'Cloud container subject to community traffic quotas and queue times.', 'https://huggingface.co/spaces/Jackiesixnine/Krea-2-Turbo_v2', '[{"text":"Jackiesixnine/Krea-2-Turbo_v2 on Hugging Face Spaces","url":"https://huggingface.co/spaces/Jackiesixnine/Krea-2-Turbo_v2"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('Fable-5.1-Max-Reasoning-Filtered-10000x', 'MoreThought', 'Dataset', 'AI Coding', 'APACHE-2.0', 2026, '10K<n<100K', 'Dataset Description 	 This dataset contains 10,000 agentic coding and reasoning multi-turn high-quality traces generated by the new Fable 5.1 model using max reasoning (157 likes, 2,613 downloads).', 'Parquet / Arrow structured tabular & tokenized dataset.', 'from datasets import load_dataset

dataset = load_dataset("MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x")', 'Trending Score: 82, Likes: 157, Downloads: 2,613', 'Subject to licensing compliance and dataset-specific terms of use.', 'https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x', '[{"text":"MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x on Hugging Face Datasets","url":"https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('Audio8-ASR-Infinite', 'Edge0', 'Model', 'Audio', 'APACHE-2.0', 2026, 'Open Weights', 'High-performance Audio open-weights model by Edge0, trending with over 605 community likes and 2,853 downloads on Hugging Face.', 'Edge0 automatic speech recognition architecture with community-tuned weights.', 'from transformers import AutoModelForCausalLM, AutoTokenizer

model = AutoModelForCausalLM.from_pretrained("Edge0/Audio8-ASR-Infinite", device_map="auto")
tokenizer = AutoTokenizer.from_pretrained("Edge0/Audio8-ASR-Infinite")', 'Trending Score: 541, Likes: 605, Downloads: 2,853', 'Requires GPU VRAM or quantization for efficient local deployment.', 'https://huggingface.co/Edge0/Audio8-ASR-Infinite', '[{"text":"Edge0/Audio8-ASR-Infinite on Hugging Face","url":"https://huggingface.co/Edge0/Audio8-ASR-Infinite"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
...
INSERT INTO entries (name, org, type, task, license, year, size, summary, architecture, usage, benchmarks, limitations, url, citations, popular, approved)
VALUES ('Qwen-Image-2.1-viggle-turbo', 'Viggle', 'Platform', 'Image Generation', 'Community Hosted', 2026, 'GRADIO Platform', 'Interactive AI web platform and demonstration hosted on Hugging Face Spaces by Viggle. Trending with 61 community stars.', 'GRADIO cloud runtime container with interactive browser interface.', 'Launch and explore the platform directly in your browser: https://huggingface.co/spaces/Viggle/Qwen-Image-2.1-viggle-turbo', 'Trending Score: 59, Community Likes: 61', 'Cloud container subject to community traffic quotas and queue times.', 'https://huggingface.co/spaces/Viggle/Qwen-Image-2.1-viggle-turbo', '[{"text":"Viggle/Qwen-Image-2.1-viggle-turbo on Hugging Face Spaces","url":"https://huggingface.co/spaces/Viggle/Qwen-Image-2.1-viggle-turbo"}]'::jsonb, true, true)
ON CONFLICT (name) DO UPDATE SET
  org = EXCLUDED.org,
  type = EXCLUDED.type,
  task = EXCLUDED.task,
