...
export const entries: Entry[] = [
  ...
  {
      "name": "Edge0-35B-A3B-preview",
      "type": "Model",
      "summary": "High-performance NLP open-weights model by Edge0, trending with over 538 community likes and 1,596 downloads on Hugging Face.",
      "task": "NLP",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "Edge0",
      "size": "35B params",
      "architecture": "Edge0 text generation architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"Edge0/Edge0-35B-A3B-preview\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"Edge0/Edge0-35B-A3B-preview\")",
      "benchmarks": "Trending Score: 520, Likes: 538, Downloads: 1,596",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/Edge0/Edge0-35B-A3B-preview",
      "citations": [
          {
              "text": "Edge0/Edge0-35B-A3B-preview on Hugging Face",
              "url": "https://huggingface.co/Edge0/Edge0-35B-A3B-preview"
          }
      ]
  },
  {
      "name": "Wan_2.2_I2V_14B_Custom_Lora_Wow",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by Cockdaddyfuck. Trending with 113 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "Cockdaddyfuck",
      "size": "GRADIO Platform",
      "architecture": "GRADIO cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/Cockdaddyfuck/Wan_2.2_I2V_14B_Custom_Lora_Wow",
      "benchmarks": "Trending Score: 73, Community Likes: 113",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/Cockdaddyfuck/Wan_2.2_I2V_14B_Custom_Lora_Wow",
      "citations": [
          {
              "text": "Cockdaddyfuck/Wan_2.2_I2V_14B_Custom_Lora_Wow on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/Cockdaddyfuck/Wan_2.2_I2V_14B_Custom_Lora_Wow"
          }
      ]
  },
  {
      "name": "horus",
      "type": "Framework",
      "summary": "Fastest Robotics Runtime System.  If phones have Android, robots deserve HORUS.",
      "task": "MLOps",
      "license": "Apache-2.0",
      "year": 2026,
      "org": "softmata",
      "size": "146MB Repo",
      "architecture": "Modular AI codebase with native Python/C++ bindings and distributed workflow support.",
      "usage": "git clone https://github.com/softmata/horus\ncd horus\npip install -e .",
      "benchmarks": "GitHub Stars: 435, Forks: 31",
      "limitations": "Requires local Python environment and dependency configuration.",
      "popular": true,
      "url": "https://github.com/softmata/horus",
      "citations": [
          {
              "text": "softmata/horus on GitHub",
              "url": "https://github.com/softmata/horus"
          }
      ]
  },
  {
      "name": "hh-rlhf",
      "type": "Dataset",
      "summary": "Dataset Card for HH-RLHF \t \t \t\t \t \t \t\tDataset Summary \t This repository provides access to two different kinds of data: Human preference data about helpfulness and harm (2,043 likes, 39,538 downloads).",
      "task": "NLP",
      "license": "MIT",
      "year": 2026,
      "org": "Anthropic",
      ...
      "benchmarks": "Trending Score: 33, Likes: 2,043, Downloads: 39,538",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": true,
      "url": "https://huggingface.co/datasets/Anthropic/hh-rlhf",
      "citations": [
          {
              "text": "Anthropic/hh-rlhf on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/Anthropic/hh-rlhf"
          }
      ]
  },
  ...
  },
  {
      "name": "NeoHorse-1-4B",
      "type": "Model",
      "summary": "High-performance NLP open-weights model by TokenRhythm, trending with over 2,056 community likes and 11,904 downloads on Hugging Face.",
      "task": "NLP",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "TokenRhythm",
      "size": "4B params",
      "architecture": "TokenRhythm text generation architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"TokenRhythm/NeoHorse-1-4B\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"TokenRhythm/NeoHorse-1-4B\")",
      "benchmarks": "Trending Score: 392, Likes: 2,056, Downloads: 11,904",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/TokenRhythm/NeoHorse-1-4B",
      "citations": [
          {
              "text": "TokenRhythm/NeoHorse-1-4B on Hugging Face",
              "url": "https://huggingface.co/TokenRhythm/NeoHorse-1-4B"
          }
      ]
  },
  {
      "name": "ai-notes",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by Lynote. Trending with 99 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "Lynote",
      "size": "STATIC Platform",
      "architecture": "STATIC cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/Lynote/ai-notes",
      "benchmarks": "Trending Score: 81, Community Likes: 99",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/Lynote/ai-notes",
      "citations": [
          {
              "text": "Lynote/ai-notes on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/Lynote/ai-notes"
          }
      ]
  },
  {
      "name": "Fable-5.1-Max-Reasoning-Filtered-5000x",
      "type": "Dataset",
      "summary": "Dataset Description \t This dataset contains 5,000 coding and reasoning traces generated by the new Fable 5.1 model using max reasoning effort. It holds almost 150,000,0 (50 likes, 950 downloads).",
      "task": "AI Coding",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "MoreThought",
      "size": "1K<n<10K",
      "architecture": "Parquet / Arrow structured tabular & tokenized dataset.",
      "usage": "from datasets import load_dataset\n\ndataset = load_dataset(\"MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x\")",
      "benchmarks": "Trending Score: 33, Likes: 50, Downloads: 950",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": false,
      "url": "https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x",
      "citations": [
          {
              "text": "MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-5000x"
          }
      ]
  },
  {
      "name": "Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF",
      "type": "Model",
      "summary": "High-performance Multimodal open-weights model by DavidAU, trending with over 798 community likes and 1,049,586 downloads on Hugging Face.",
      "task": "Multimodal",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "DavidAU",
      "size": "27B params",
      "architecture": "DavidAU image text to text architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF\")",
      "benchmarks": "Trending Score: 340, Likes: 798, Downloads: 1,049,586",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF",
      "citations": [
          {
              "text": "DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF on Hugging Face",
              "url": "https://huggingface.co/DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF"
          }
      ]
  },
  {
      "name": "hfviewer",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by embedl. Trending with 70 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "embedl",
      "size": "STATIC Platform",
      "architecture": "STATIC cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/embedl/hfviewer",
      "benchmarks": "Trending Score: 67, Community Likes: 70",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/embedl/hfviewer",
      "citations": [
          {
              "text": "embedl/hfviewer on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/embedl/hfviewer"
          }
      ]
  },
  {
      "name": "wikipedia",
      "type": "Dataset",
      "summary": "Dataset Card for Wikimedia Wikipedia \t \t \t\t \t \t \t\tDataset Summary \t Wikipedia dataset containing cleaned articles of all languages. The dataset is built from the Wikipe (1,467 likes, 264,787 downloads).",
      "task": "NLP",
      ...
      "benchmarks": "Trending Score: 27, Likes: 1,467, Downloads: 264,787",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": true,
      "url": "https://huggingface.co/datasets/wikimedia/wikipedia",
      "citations": [
          {
              "text": "wikimedia/wikipedia on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/wikimedia/wikipedia"
          }
      ]
  },
  {
      ...
      "type": "Model",
      "summary": "High-performance Multimodal open-weights model by ukisai, trending with over 396 community likes and 3,221 downloads on Hugging Face.",
      "task": "Multimodal",
      "license": "OTHER",
      "year": 2026,
      "org": "ukisai",
      "size": "27B params",
      "architecture": "ukisai image text to text architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"ukisai/Swift-Qwen3.8-27b\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"ukisai/Swift-Qwen3.8-27b\")",
      "benchmarks": "Trending Score: 380, Likes: 396, Downloads: 3,221",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/ukisai/Swift-Qwen3.8-27b",
      "citations": [
          {
              "text": "ukisai/Swift-Qwen3.8-27b on Hugging Face",
              "url": "https://huggingface.co/ukisai/Swift-Qwen3.8-27b"
          }
      ]
  },
  {
      "name": "wan2-2-i2v-v3",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by observantdistressed. Trending with 78 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "observantdistressed",
      "size": "GRADIO Platform",
      "architecture": "GRADIO cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/observantdistressed/wan2-2-i2v-v3",
      "benchmarks": "Trending Score: 68, Community Likes: 78",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/observantdistressed/wan2-2-i2v-v3",
      "citations": [
          {
              "text": "observantdistressed/wan2-2-i2v-v3 on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/observantdistressed/wan2-2-i2v-v3"
          }
      ]
  },
  {
      "name": "World-SimReady-Home",
      "type": "Dataset",
      "summary": "WorldSimReady-Home \t \t \t\t \t \t \t\tDataset description \t CAD-based SimReady assets Optimized CAD assets with configured collision and physical properties. Manually reviewe (34 likes, 424 downloads).",
      "task": "Computer Vision",
      ...
      "size": "Curated Dataset",
      "architecture": "Parquet / Arrow structured tabular & tokenized dataset.",
      "usage": "from datasets import load_dataset\n\ndataset = load_dataset(\"Yootta/World-SimReady-Home\")",
      "benchmarks": "Trending Score: 31, Likes: 34, Downloads: 424",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": false,
      "url": "https://huggingface.co/datasets/Yootta/World-SimReady-Home",
      "citations": [
          {
              "text": "Yootta/World-SimReady-Home on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/Yootta/World-SimReady-Home"
          }
      ]
  },
  {
      ...
      "type": "Model",
      "summary": "High-performance NLP open-weights model by prism-ml, trending with over 945 community likes and 405,609 downloads on Hugging Face.",
      "task": "NLP",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "prism-ml",
      "size": "27B params",
      "architecture": "prism-ml text generation architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"prism-ml/Ternary-Bonsai-2-27B-gguf\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"prism-ml/Ternary-Bonsai-2-27B-gguf\")",
      "benchmarks": "Trending Score: 898, Likes: 945, Downloads: 405,609",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/prism-ml/Ternary-Bonsai-2-27B-gguf",
      "citations": [
          {
              "text": "prism-ml/Ternary-Bonsai-2-27B-gguf on Hugging Face",
              "url": "https://huggingface.co/prism-ml/Ternary-Bonsai-2-27B-gguf"
          }
      ]
  },
  {
      "name": "MiniCPM5-2B-WebGPU-Pi",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by victor. Trending with 69 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "victor",
      "size": "STATIC Platform",
      "architecture": "STATIC cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/victor/MiniCPM5-2B-WebGPU-Pi",
      "benchmarks": "Trending Score: 67, Community Likes: 69",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/victor/MiniCPM5-2B-WebGPU-Pi",
      "citations": [
          {
              "text": "victor/MiniCPM5-2B-WebGPU-Pi on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/victor/MiniCPM5-2B-WebGPU-Pi"
          }
      ]
  },
  {
      "name": "Minimax-H3",
      "type": "Dataset",
      "summary": "Install Minimax H3 in ComfyUI (NVFP4/BF16/FP8/GGUF): \t https://www.stablediffusiontutorials.com/2026/08/minimax-h3.html (29 likes, 479 downloads).",
      "task": "NLP",
      "license": "MIT",
      "year": 2026,
      "org": "stablediffusiontutorials",
      "size": "Curated Dataset",
      "architecture": "Parquet / Arrow structured tabular & tokenized dataset.",
      "usage": "from datasets import load_dataset\n\ndataset = load_dataset(\"stablediffusiontutorials/Minimax-H3\")",
      "benchmarks": "Trending Score: 29, Likes: 29, Downloads: 479",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": false,
      "url": "https://huggingface.co/datasets/stablediffusiontutorials/Minimax-H3",
      "citations": [
          {
              "text": "stablediffusiontutorials/Minimax-H3 on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/stablediffusiontutorials/Minimax-H3"
          }
      ]
  },
  ...
  },
  {
      ...
      "type": "Model",
      "summary": "High-performance Image Generation open-weights model by abenzerps, trending with over 1,144 community likes and 182,313 downloads on Hugging Face.",
      "task": "Image Generation",
      "license": "OTHER",
      "year": 2026,
      "org": "abenzerps",
      "size": "Open Weights",
      "architecture": "abenzerps text to image architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"abenzerps/Qwen-Image-2.1-Uncensored-GGUF\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"abenzerps/Qwen-Image-2.1-Uncensored-GGUF\")",
      "benchmarks": "Trending Score: 1027, Likes: 1,144, Downloads: 182,313",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/abenzerps/Qwen-Image-2.1-Uncensored-GGUF",
      "citations": [
          {
              "text": "abenzerps/Qwen-Image-2.1-Uncensored-GGUF on Hugging Face",
              "url": "https://huggingface.co/abenzerps/Qwen-Image-2.1-Uncensored-GGUF"
          }
      ]
  },
  {
      "name": "jev-decision-index",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by multimodalart. Trending with 137 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "multimodalart",
      "size": "STATIC Platform",
      "architecture": "STATIC cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/multimodalart/jev-decision-index",
      "benchmarks": "Trending Score: 134, Community Likes: 137",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/multimodalart/jev-decision-index",
      "citations": [
          {
              "text": "multimodalart/jev-decision-index on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/multimodalart/jev-decision-index"
          }
      ]
  },
  {
      ...
      "type": "Dataset",
      "summary": "saas-sales-conversations \t \t \t\t \t\tDataset Description \t This is a synthetic dataset of sales conversations for SaaS (Software as a Service) companies, designed for training (46 likes, 728 downloads).",
      "task": "NLP",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "DeepMostInnovations",
      "size": "100K<n<1M",
      "architecture": "Parquet / Arrow structured tabular & tokenized dataset.",
      "usage": "from datasets import load_dataset\n\ndataset = load_dataset(\"DeepMostInnovations/saas-sales-conversations\")",
      "benchmarks": "Trending Score: 35, Likes: 46, Downloads: 728",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": false,
      "url": "https://huggingface.co/datasets/DeepMostInnovations/saas-sales-conversations",
      "citations": [
          {
              "text": "DeepMostInnovations/saas-sales-conversations on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/DeepMostInnovations/saas-sales-conversations"
          }
      ]
  },
  {
      "name": "Hemmingway-1",
      "type": "Model",
      "summary": "High-performance NLP open-weights model by Altworld, trending with over 579 community likes and 3,787 downloads on Hugging Face.",
      "task": "NLP",
      "license": "CC-BY-NC-4.0",
      "year": 2026,
      "org": "Altworld",
      "size": "Open Weights",
      "architecture": "Altworld text generation architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"Altworld/Hemmingway-1\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"Altworld/Hemmingway-1\")",
      "benchmarks": "Trending Score: 565, Likes: 579, Downloads: 3,787",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/Altworld/Hemmingway-1",
      "citations": [
          {
              "text": "Altworld/Hemmingway-1 on Hugging Face",
              "url": "https://huggingface.co/Altworld/Hemmingway-1"
          }
      ]
  },
  {
      "name": "qwen-image-2-1",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by hugging-apps. Trending with 92 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "hugging-apps",
      "size": "GRADIO Platform",
      "architecture": "GRADIO cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/hugging-apps/qwen-image-2-1",
      "benchmarks": "Trending Score: 80, Community Likes: 92",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/hugging-apps/qwen-image-2-1",
      "citations": [
          {
              "text": "hugging-apps/qwen-image-2-1 on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/hugging-apps/qwen-image-2-1"
          }
      ]
  },
  {
      "name": "tracker-pov",
      "type": "Dataset",
      "summary": "Eidon Tracker POV \t 1,274 hours of egocentric video paired with 7-point IMU arm tracking, recorded during ordinary household work. Contributors wore a head-mounted came (38 likes, 10,594 downloads).",
      "task": "NLP",
      "license": "CC-BY-4.0",
      "year": 2026,
      "org": "eidon-ai",
      "size": "10K<n<100K",
      "architecture": "Parquet / Arrow structured tabular & tokenized dataset.",
      "usage": "from datasets import load_dataset\n\ndataset = load_dataset(\"eidon-ai/tracker-pov\")",
      "benchmarks": "Trending Score: 38, Likes: 38, Downloads: 10,594",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": false,
      "url": "https://huggingface.co/datasets/eidon-ai/tracker-pov",
      "citations": [
          {
              "text": "eidon-ai/tracker-pov on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/eidon-ai/tracker-pov"
          }
      ]
  },
  {
      "name": "ZDTaichu5.0-9B",
      "type": "Model",
      "summary": "High-performance Multimodal open-weights model by TaichuAI, trending with over 1,041 community likes and 8,313 downloads on Hugging Face.",
      "task": "Multimodal",
      "license": "Open Weights",
      "year": 2026,
      "org": "TaichuAI",
      "size": "9B params",
      "architecture": "TaichuAI image text to text architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"TaichuAI/ZDTaichu5.0-9B\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"TaichuAI/ZDTaichu5.0-9B\")",
      "benchmarks": "Trending Score: 481, Likes: 1,041, Downloads: 8,313",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/TaichuAI/ZDTaichu5.0-9B",
      "citations": [
          {
              "text": "TaichuAI/ZDTaichu5.0-9B on Hugging Face",
              "url": "https://huggingface.co/TaichuAI/ZDTaichu5.0-9B"
          }
      ]
  },
  {
      "name": "Krea-2-Turbo_v2",
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by Jackiesixnine. Trending with 113 community stars.",
      "task": "Multimodal",
      "license": "Community Hosted",
      "year": 2026,
      "org": "Jackiesixnine",
      "size": "GRADIO Platform",
      "architecture": "GRADIO cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/Jackiesixnine/Krea-2-Turbo_v2",
      "benchmarks": "Trending Score: 86, Community Likes: 113",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/Jackiesixnine/Krea-2-Turbo_v2",
      "citations": [
          {
              "text": "Jackiesixnine/Krea-2-Turbo_v2 on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/Jackiesixnine/Krea-2-Turbo_v2"
          }
      ]
  },
  {
      "name": "Fable-5.1-Max-Reasoning-Filtered-10000x",
      "type": "Dataset",
      "summary": "Dataset Description \t This dataset contains 10,000 agentic coding and reasoning multi-turn high-quality traces generated by the new Fable 5.1 model using max reasoning (157 likes, 2,613 downloads).",
      "task": "AI Coding",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "MoreThought",
      "size": "10K<n<100K",
      "architecture": "Parquet / Arrow structured tabular & tokenized dataset.",
      "usage": "from datasets import load_dataset\n\ndataset = load_dataset(\"MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x\")",
      "benchmarks": "Trending Score: 82, Likes: 157, Downloads: 2,613",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": true,
      "url": "https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x",
      "citations": [
          {
              "text": "MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/MoreThought/Fable-5.1-Max-Reasoning-Filtered-10000x"
          }
      ]
  },
  {
      ...
      "type": "Model",
      "summary": "High-performance Audio open-weights model by Edge0, trending with over 605 community likes and 2,853 downloads on Hugging Face.",
      "task": "Audio",
      "license": "APACHE-2.0",
      "year": 2026,
      "org": "Edge0",
      "size": "Open Weights",
      "architecture": "Edge0 automatic speech recognition architecture with community-tuned weights.",
      "usage": "from transformers import AutoModelForCausalLM, AutoTokenizer\n\nmodel = AutoModelForCausalLM.from_pretrained(\"Edge0/Audio8-ASR-Infinite\", device_map=\"auto\")\ntokenizer = AutoTokenizer.from_pretrained(\"Edge0/Audio8-ASR-Infinite\")",
      "benchmarks": "Trending Score: 541, Likes: 605, Downloads: 2,853",
      "limitations": "Requires GPU VRAM or quantization for efficient local deployment.",
      "popular": true,
      "url": "https://huggingface.co/Edge0/Audio8-ASR-Infinite",
      "citations": [
          {
              "text": "Edge0/Audio8-ASR-Infinite on Hugging Face",
              "url": "https://huggingface.co/Edge0/Audio8-ASR-Infinite"
          }
      ]
  },
  {
      ...
      "type": "Platform",
      "summary": "Interactive AI web platform and demonstration hosted on Hugging Face Spaces by Viggle. Trending with 61 community stars.",
      "task": "Image Generation",
      "license": "Community Hosted",
      "year": 2026,
      "org": "Viggle",
      "size": "GRADIO Platform",
      "architecture": "GRADIO cloud runtime container with interactive browser interface.",
      "usage": "Launch and explore the platform directly in your browser: https://huggingface.co/spaces/Viggle/Qwen-Image-2.1-viggle-turbo",
      "benchmarks": "Trending Score: 59, Community Likes: 61",
      "limitations": "Cloud container subject to community traffic quotas and queue times.",
      "popular": true,
      "url": "https://huggingface.co/spaces/Viggle/Qwen-Image-2.1-viggle-turbo",
      "citations": [
          {
              "text": "Viggle/Qwen-Image-2.1-viggle-turbo on Hugging Face Spaces",
              "url": "https://huggingface.co/spaces/Viggle/Qwen-Image-2.1-viggle-turbo"
          }
      ]
  },
  {
      "name": "OmniVChat",
      "type": "Dataset",
      "summary": "OmniVChat: Synthesizing, Benchmarking, and Training for Native Audio-Visual Dialogue \t &nbsp;&nbsp;&nbsp;&nbsp; 1 The Chinese University of Hong Kong 2 Alibaba Token Hu (39 likes, 1,473 downloads).",
      "task": "Audio",
      ...
      "size": "1K<n<10K",
      "architecture": "Parquet / Arrow structured tabular & tokenized dataset.",
      "usage": "from datasets import load_dataset\n\ndataset = load_dataset(\"Harland/OmniVChat\")",
      "benchmarks": "Trending Score: 39, Likes: 39, Downloads: 1,473",
      "limitations": "Subject to licensing compliance and dataset-specific terms of use.",
      "popular": false,
      "url": "https://huggingface.co/datasets/Harland/OmniVChat",
      "citations": [
          {
              "text": "Harland/OmniVChat on Hugging Face Datasets",
              "url": "https://huggingface.co/datasets/Harland/OmniVChat"
          }
      ]
  }
